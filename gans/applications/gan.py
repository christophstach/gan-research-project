...
class GAN(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("-gf", "--generator-filters", type=int, default=256, help="Filter multiplier in the generator")
        parser.add_argument("-cf", "--discriminator-filters", type=int, default=256, help="Filter multiplier in the discriminator")
